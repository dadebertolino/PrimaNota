...
Public Class DBFormTableDB_XPO
    ...
    <System.ComponentModel.Category("DBBaseLib"), System.ComponentModel.Description("L' Oggetto XPO")> Protected Property xpoObject() As DevExpress.Xpo.XPObject
        Get
            Return Me.lxpObject
        End Get
...
#End Region
    ...
    Private Sub DBFormTable_DBEventoRinfrescaCorrente() Handles Me.DBEventoRinfrescaCorrente
        ...
        End If
        Dim Oggetto As DevExpress.Xpo.XPObject
        Oggetto = TryCast(Me.lbsNavigazione.Current, DevExpress.Xpo.XPObject)
        If Not Oggetto Is Nothing Then
            Me.lxpObject = Oggetto
            If Me.DBStato = BaseLib.DBStato.Chiave Then
    ...
    Private Sub btnNewRecord_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNewRecord.Click, tbbNew.Click
        Try
            Dim DesTipo As String = Me.xpcCollection.ObjectClassInfo.FullName
            Dim b As Assembly = System.Reflection.Assembly.Load(Me.xpcCollection.ObjectClassInfo.AssemblyName)
            Me.xpoObject = b.CreateInstance(DesTipo) '(Me.xpcCollection.Session)
        ...
        'Me.xpoObject=New Gettype(  Me.xpcCollection.ObjectClassInfo())
    ...
    Private Function SalvaDati() As Boolean
        ...
        If Not Me.xpoObject Is Nothing Then
            Me.xpoObject.Save()
        End If
        If Not Me.xpcCollection Is Nothing Then
            Me.xpcCollection.Reload()
        End If
        RaiseEvent DBSalvaDati()
        RaiseEvent DBUpdateDataGridView()
        Me.SplashScreenManager1.CloseWaitForm()
    ...
    Private Sub btnConferma_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConferma.Click, tbbSave.Click
        If Me.SalvaDati = True Then
            Me.DBStato = BaseLib.DBStato.Chiave
            If Not Me.lxpObject Is Nothing Then
                RaiseEvent DBEventoRinfrescaCorrente()
            End If
        End If
    End Sub
    ...
    Private Sub tbbStampa_Click(sender As Object, e As EventArgs) Handles tbbStampa.Click
        RaiseEvent DBStampa()
    End Sub
End Class